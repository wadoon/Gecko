...
/**
 * A concrete representation of an [Action] that removes a [Port] from the given parent-[System].
 */
class DeletePortViewModelElementAction(val gModel: GModel, val Port: Port, val system: System) :
