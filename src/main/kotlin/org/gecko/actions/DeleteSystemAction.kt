...
/** A concrete representation of an [Action] that removes a [System] from a given [System]. */
class DeleteSystemAction(val gModel: GModel, val system: System, val parentSystem: System) :
