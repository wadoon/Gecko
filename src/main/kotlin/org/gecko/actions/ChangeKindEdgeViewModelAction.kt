...
/**
 * Represents a type of [Action] that changes the [Kind] of an [Edge], which it holds a references
 * to. Additionally, holds the old and new [Kind]s of the edge for undo/redo purposes.
 */
