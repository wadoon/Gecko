 ...
 * [Actions][org.gecko.actions.Action], can be either run or undone by the [org.gecko.actions.ActionManager].
 * The [org.gecko.actions.ActionFactory] is responsible for creating instances of each of these actions. Actions
 * can also be grouped in an [org.gecko.actions.ActionGroup], which represents an action that runs or undoes
 * multiple actions iteratively. The actions fall into the following categories:
 *
 *  *
 * **Creating [AbstractViewModelElements][org.gecko.viewmodel.AbstractViewModelElement]**:
 * These actions use the [ViewModelFactory][org.gecko.viewmodel.ViewModelFactory] to create
 ...
 *
 *  *
 * **Deleting [AbstractViewModelElements][org.gecko.viewmodel.AbstractViewModelElement]**:
 ...
 *
 *  *
 * **Restoring [AbstractViewModelElements][org.gecko.viewmodel.AbstractViewModelElement]**:
 ...
 *
 *  *
 * **Changing the properties of [         AbstractViewModelElements][org.gecko.viewmodel.AbstractViewModelElement]**: These actions change the values of different properties of the view model
 * elements. Undoing a property change is provided through the same change-action given the old value of the
 * property.
 *
 *
 *  *
 * **Renaming [BlockViewModelElements][org.gecko.viewmodel.BlockViewModelElement]**:
 ...
 *
 *  *
 * **Copying, pasting or cutting [         PositionableViewModelElements][org.gecko.viewmodel.PositionableViewModelElement]**: These actions manage the creation of new view model elements with the
 ...
 *
 *  *
 * **Selecting, deselecting and focusing [         PositionableViewModelElements][org.gecko.viewmodel.PositionableViewModelElement]**: These actions manage the selection and deselection of view model
 ...
 *
 *  *
 * **Moving and scaling [         PositionableViewModelElements][org.gecko.viewmodel.PositionableViewModelElement]**: These actions manage moving the view model elements in the view or
 ...
 *
 *  *
 * **Switching views**: This action switches between the system view and the automaton view of a current
 * system. Undoing the view switch is provided by the same view-switch-action given the old view's values.
 *
 *
 *  *
 * **Zooming in or out of the view**: These actions zoom in or out of the view by a given factor from a fixed
