 ...
 */
internal enum class LayoutAlgorithms(val clazz: Class<out IGraphLayoutEngine>) {
    FORCE(ForceLayoutProvider::class.java),
    LAYERED(LayeredLayoutProvider::class.java);
}
