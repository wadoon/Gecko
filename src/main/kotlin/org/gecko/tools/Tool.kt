...
/**
 * An abstract representation of a tool used in the Gecko Graphic Editor, characterized by a
 * [ToolType]. Follows the visitor pattern, implementing the [ViewElementVisitor] interface. Defines
 * the [MouseEvent] [EventHandler]s for each
 * [ViewElement][org.gecko.view.views.viewelement.ViewElement].
 */
abstract class Tool
protected constructor(
    ...
    /**
     * Applies listeners to the given view, which is assumed to be the current view of the
     * application.
     *
    ...
    open fun visitView(pane: ViewElementPane) {
        ...
        pane.world.onScroll =
            EventHandler<ScrollEvent> { e: ScrollEvent ->
    ...
    /**
     * Overriden by specific tools to handle interaction with a state view element. By default,
     * consumes all events.
     *
    ...
    /**
     * Overriden by specific tools to handle interaction with an edge view element. By default,
     * consumes all events.
     *
    ...
    /**
     * Overriden by specific tools to handle interaction with a region view element. By default,
    ...
    /**
     * Overriden by specific tools to handle interaction with a system view element. By default,
     * consumes all events.
     *
    ...
    /**
     * Overriden by specific tools to handle interaction with a system connection view element. By
     * default, consumes all events.
     *
    ...
    /**
     * Overriden by specific tools to handle interaction with a variable block view element. By
     * default, consumes all events.
     *
    ...
    /**
     * Overriden by specific tools to handle interaction with a block element scaler view element
     * decorator. By default, lets events pass through.
     *
     * @param elementScalarViewElementDecorator the block element scaler view element decorator to
     *   visit
     */
    ...
    /**
     * Overriden by specific tools to handle interaction with a connection element scaler view
     * element decorator. By default, lets events pass through.
     *
     * @param connectionElementScalerViewElementDecorator the connection element scaler view element
     *   decorator to visit
     */
    override fun visit(
     ...
     * decorator. By default, lets events pass through.
     *
     * @param blockElementScalerViewElementDecorator the block element scaler view element decorator
     *   to visit
     */
    override fun visit(
    ...
    /**
     * Overriden by specific tools to handle interaction with a port view element. By default,
     * consumes all events.
     *
