...
/**
 * Enumerates the types of keyboard shortcuts used in the Gecko Graphic Editor. Each [Shortcut][Shortcuts] is
 * described by a [KeyCode] and a [Modifier][KeyCombination.Modifier].
 */
