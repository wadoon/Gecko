...
/**
 * A concrete representation of a [ViewElementDecorator] following the decorator pattern for scaling purposes. It
 * holds a reference to a Group containing the drawn target and a list of [ElementScalerBlock]s, one for each edge
