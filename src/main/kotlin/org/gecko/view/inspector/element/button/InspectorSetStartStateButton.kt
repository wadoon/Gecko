...
class InspectorSetStartStateButton(actionManager: ActionManager, state: State) :
    ToggleButton(), InspectorElement<ToggleButton> {
    init {
        ...
        state.isStartStateProperty.addListener {
