 ...
 */
public class InspectorVariableListBox extends AbstractInspectorList<InspectorVariableField> {
    ...
    public InspectorVariableListBox(ActionManager actionManager, SystemViewModel viewModel, Visibility visibility) {
